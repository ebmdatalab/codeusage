...
The goal of `codeusage` is to make yearly summaries of **SNOMED Code Usage in Primary Care** and **ICD-10 Code Usage in Secondary Care** in England, published by NHS Digital available in R for research. The original data is available from NHS Digital at:
...
-   [ICD-10 Code Usage in Secondary Care](https://digital.nhs.uk/data-and-information/publications/statistical/hospital-admitted-patient-care-activity)
...
This package contains ICD-10 codes included in all diagnosis fields of the Finished Consultant Episodes (FCE) in the Hospital Episode Statistics in England.
